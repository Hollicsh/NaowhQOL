...
ns:RegisterLocale("zhTW", {
    ...
    DRAGON_SHOW_THRILL_TICK = "顯示激動標記",
    ...
    TIME_SPIRAL_TEXT_DEFAULT = "自由移動",
    TIME_SPIRAL_TEXT_FORMAT = "文字格式：",
    TIME_SPIRAL_TEXT_FORMAT_DEFAULT = "自由移動\\n%ts",
    TIME_SPIRAL_TEXT_FORMAT_HELP = "%t = 剩餘時間, \\n = 換行",
