...
ns:RegisterLocale("zhTW", {
    ...
    DRAGON_HIDE_BCM = "騎乘時隱藏 CDM 資源條",
    DRAGON_HIDE_BCM_DESC = "在天空騎乘時隱藏 CDM 的資源條。",
    ...
    STEALTH_STANCE_INSTANCE_ONLY = "僅在副本 / 團隊副本",
    STEALTH_GROUP_ONLY = "僅組隊顯示（單人時隱藏）",
    ...
    BWV2_RAID_BUFF_ALWAYS_CHECK = "始終監控我的團隊增益",
    ...
    IMPORTEXPORT_IMPORT_OK_PROFILE = "已匯入至新設定檔：%s",
    IMPORTEXPORT_IMPORT_ERR     = "匯入失敗。",
    IMPORTEXPORT_POPUP_RENAME   = "將設定檔 '%s' 重新命名為：",
    IMPORTEXPORT_POPUP_NEW      = "使用預設設定建立新設定檔：",
    IMPORTEXPORT_POPUP_IMPORT   = "輸入要匯入的新設定檔名稱：",
    IMPORTEXPORT_POPUP_DELETE   = "刪除設定檔 '%s'？",
    IMPORTEXPORT_POPUP_RESET    = "將預設設定檔重設為出廠設定？\n\n這將關閉所有功能並重設所有顏色/位置。需要重新載入。",
    IMPORTEXPORT_RESET_BTN      = "重設為預設值",
    IMPORTEXPORT_RESET_OK       = "預設設定檔已重設 — 請重新載入以套用",
    IMPORTEXPORT_RESET_ERR_NAMED = "重設僅適用於預設設定檔",
    ...
    GENERAL_SECTION_OPTIONS = "選項",
    GENERAL_DISABLE_LOGIN_MSG = "停用登入訊息",
