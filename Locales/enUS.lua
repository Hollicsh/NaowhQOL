...
ns:RegisterLocale("enUS", {
    ...
    COMMON_SECTION_POSITION = "POSITION",
    ...
    GENERAL_SECTION_FONT = "FONTS",
    GENERAL_SECTION_FONTS = "FONTS",
    GENERAL_FONT_DESC = "Choose the font NaowhQOL modules use. Game UI fonts are left as Blizzard default unless you opt in below.",
    GENERAL_GAME_FONT = "Game UI Font Replacement",
    GENERAL_GAME_FONT_OPT_IN = "Apply NaowhQOL font to game UI fonts",
    GENERAL_GAME_FONT_DESC = "Off by default. Enable this only if you want NaowhQOL to update game UI text where it can safely do so.",
    GENERAL_QOL_FONT = "NaowhQOL Module Font",
    GENERAL_QOL_FONT_OVERRIDE = "Use a separate NaowhQOL font",
    ...
    COMBATALERT_NOTE = "Note: Shows separate enter and leave combat messages with optional sound or TTS for each transition.",
    ...
    COMBATTIMER_NOTE = "Note: Starts when combat begins, can stay visible after the pull, and can report the final duration to chat.",
    ...
    DRAGON_NOTE = "Note: Builds a custom skyriding HUD for speed, vigor, and surge cues. Anchor options let it follow another frame.",
    ...
    DRAGON_HIDE_CDM_EUI = "Controlled by EllesmereUI (Hide when Mounted).",
    DRAGON_HIDE_BCM = "Hide Resource Bars While Mounted",
    DRAGON_HIDE_BCM_DESC = "Hides CooldownManager resource bars while skyriding.",
    DRAGON_HIDE_BCM_EUI = "Controlled by EllesmereUI (Hide when Mounted / Dragonriding).",
    ...
    FOCUS_SHOW_CAST_TARGET = "Show Cast Target",
    ...
    FOCUS_HIDE_NONINT = "Hide Non-Interruptible Casts",
    FOCUS_NONINT_COLOR = "Non-Interruptible",
    FOCUS_INTERRUPTED = "Interrupted",
    FOCUS_INTERRUPTED_COLOR = "Interrupted Color",
    FOCUS_INTERRUPTED_FADE = "Interrupted Fade (sec)",
    FOCUS_SHOW_INTERRUPTER = "Show Interrupter Name",
    ...
    MODULES_SECTION_GLOBAL_COPY = "GLOBAL COPY",
    MODULES_ENABLE_GLOBAL_COPY = "Enable Global Copy",
    MODULES_GLOBAL_COPY_DESC = "Copy text from hovered frames or specific frame names.",
    MODULES_GLOBAL_COPY_NOTE = "Note: Opens a draggable text box for visible frame text or tooltip IDs. The hotkey is ignored in combat.",
    MODULES_COPY_TOOLTIP_IDS = "Copy tooltip IDs with hotkey",
    MODULES_COPY_MODIFIER = "Modifier",
    ...
    OPT_PRESETS_NOTE = "Note: Applies a curated CVar set for FPS, raid graphics, logging, network, and visual noise. Current values are saved before applying so Revert can restore them.",
    ...
    STEALTH_POSITION = "Stealth Reminder Position",
    STANCE_POSITION = "Stance Reminder Position",

    CREZ_SUBTITLE = "Combat resurrection timer and death alerts",
    CREZ_ENABLE_TIMER = "Enable Combat Rez Timer",
    CREZ_NOTE = "Note: Tracks combat resurrection charges and cooldown recovery. Death warnings can surface the same frame when someone dies.",
    ...
    MOUSE_NOTE = "Note: Keeps a lightweight ring on the cursor with optional GCD swipe and trail effects. Visibility rules can hide it out of combat, while clicking, or when unfocused.",
    ...
    MOUSE_SHAPE_CIRCLE2 = "Soft Circle",
    MOUSE_SHAPE_CIRCLE3 = "Hard Circle",
    MOUSE_SHAPE_RING1 = "Ring 1",
    MOUSE_SHAPE_RING2 = "Ring 2",
    MOUSE_SHAPE_RING3 = "Ring 3",
    MOUSE_SHAPE_RING4 = "Ring 4",
    MOUSE_SHAPE_RING_SOFT1 = "Ring Soft 1",
    MOUSE_SHAPE_RING_SOFT2 = "Ring Soft 2",
    MOUSE_SHAPE_RING_SOFT3 = "Ring Soft 3",
    MOUSE_SHAPE_RING_SOFT4 = "Ring Soft 4",
    MOUSE_SHAPE_GLOW = "Glow",
    MOUSE_SHAPE_GLOW2 = "Glow 2",
    MOUSE_SHAPE_GLOW_REVERSED = "Glow Reversed",
    MOUSE_SHAPE_CROSS1 = "Cross",
    MOUSE_SHAPE_CROSS2 = "Cross 2",
    MOUSE_SHAPE_CROSS3 = "Cross 3",
    MOUSE_SHAPE_STAR = "Star",
    MOUSE_SHAPE_SWIRL = "Swirl",
    MOUSE_SHAPE_SPHERE = "Sphere Edge",
    ...
    MOUSE_SECTION_DISPEL_CURSOR = "DISPEL COOLDOWN",
    MOUSE_DISPEL_CURSOR_ENABLE = "Show Dispel Cooldown at Cursor",
    MOUSE_DISPEL_CURSOR_COLOR = "Text Color",
    MOUSE_DISPEL_CURSOR_OFFSET_X = "Text Offset X",
    MOUSE_DISPEL_CURSOR_OFFSET_Y = "Text Offset Y",
    MOUSE_DISPEL_CURSOR_NOTE = "Note: Finds your current friendly dispel spell, including supported pet dispels, and follows the cursor with its cooldown number.",
    ...
    MOUSE_TRAIL_SHAPE = "Trail Shape",
    MOUSE_TRAIL_SHAPE_GLOW = "Glow",
    MOUSE_TRAIL_SHAPE_CIRCLE = "Circle",
    MOUSE_TRAIL_SHAPE_RING = "Ring",
    MOUSE_TRAIL_SHAPE_STAR = "Star",
    MOUSE_TRAIL_SHAPE_SPARKLE = "Sparkle",
    MOUSE_TRAIL_SIZE = "Trail Size",
    MOUSE_TRAIL_LENGTH = "Trail Length",
    MOUSE_TRAIL_BRIGHTNESS = "Trail Brightness",
    MOUSE_TRAIL_SPARKLE = "Sparkle Colors",
    ...
    MOUSE_SECTION_DOT = "CENTER DOT",
    MOUSE_DOT_ENABLE = "Enable Center Dot",
    MOUSE_DOT_COLOR = "Dot Color",
    MOUSE_DOT_SIZE = "Dot Size",

    MOUSE_SECTION_FADE = "FADE ON IDLE",
    MOUSE_FADE_ENABLE = "Fade When Mouse Idle",
    MOUSE_FADE_DELAY = "Idle Delay (ms)",
    MOUSE_FADE_OPACITY = "Idle Opacity",

    CROSSHAIR_TITLE = "CROSSHAIR",
    CROSSHAIR_SUBTITLE = "Screen-center crosshair overlay",
    CROSSHAIR_ENABLE = "Enable Crosshair",
    CROSSHAIR_NOTE = "Note: Draws a configurable center marker for combat visibility, including shape presets, range recolor, and optional sound feedback.",
    ...
    PETTRACKER_SHOW_PASSIVE = 'Show "Pet Passive" Notifications',
    PETTRACKER_LOW_HEALTH_SHOW = "Show Low Health Warning",
    PETTRACKER_LOW_HEALTH_LABEL = "Low HP Text:",
    PETTRACKER_LOW_HEALTH_DEFAULT = "Pet Low HP",
    PETTRACKER_LOW_HEALTH_THRESHOLD = "HP Threshold:",
    ...
    MOVEMENT_ALERT_NOTE = "Note: Tracks movement tools for your current class and any custom spell IDs you add. Class filters let you silence specs that do not need it.",
    MOVEMENT_POSITION_MAIN = "Movement Alert Position",
    MOVEMENT_POSITION_SPIRAL = "Time Spiral Position",
    MOVEMENT_POSITION_GATEWAY = "Gateway Shard Position",
    ...
    TIME_SPIRAL_NOTE = "Note: Watches Blizzard proc overlay events for Time Spiral and resolves spec spell overrides before showing the free-movement alert.",
    ...
    GATEWAY_SHARD_NOTE = "Note: Watches the Gateway Control Shard item and can show a combat-only alert with sound or TTS when it is ready.",
    ...
    ALERTS_SUBTITLE = "Spell overlay, dispel, and potion-ready utilities",
    ALERTS_SPELL_ALERTS = "SPELL ALERTS",
    ALERTS_ENABLE_SPELL_ALERTS = "Enable Spell Alerts",
    ...
    ALERTS_ENABLE_GLOW_ANIM = "Enable Glow Animation",
    ALERTS_DISPEL_GLOW_NOTE = "Note: Highlights Blizzard compact group frames and common ElvUI group frames when a dispellable harmful aura is visible to the addon. Private auras still rely on Blizzard's secure indicators.",
    ALERTS_POTION_READY = "POTION READY",
    ALERTS_ENABLE_POTION = "Enable Potion Ready",
    ALERTS_POTION_TEXT = "Display Text:",
    ALERTS_INSTANCE_ONLY = "Dungeons / Raids Only",
    ALERTS_DISABLE_HEALER = "Disable for Healers",
    ALERTS_POTION_READY_NOTE = "Note: Shows a movable alert when a tracked combat potion is in your bags and off cooldown. Sound, glow, healer, and instance filters are optional.",
    ...
    BWV2_BUFF_DROP_INSTANCE_ONLY = "Dungeons / Raids Only",
    BWV2_BUFF_DROP_DISABLE_RESTED = "Hide in Rested Areas",
    BWV2_BUFF_DROP_TEXT = "Duration Text Font",
    BWV2_BUFF_DROP_NO_TINT = "No Red Tint",
    BWV2_BUFF_DROP_NO_TINT_DESC = "Show missing buffs desaturated only, without the red tint.",
    BWV2_RAID_TEXT_ONLY = "Raid Buff Text Mode",
    BWV2_RAID_TEXT_ONLY_DESC = "Show missing raid buffs as a text list in a separate anchor instead of icons.",
    BWV2_RAID_TEXT_ANCHOR = "Raid Buff Text",
    BWV2_RAID_TEXT_COLOR = "Text Color",
    BWV2_RAID_TEXT_FONT_SIZE = "Text Size",
    BWV2_BUFF_DROP_MISSING = "Missing",
    BWV2_RAID_BUFF_ALWAYS_CHECK = "Always Monitor My Raid Buffs",
    BWV2_RAID_BUFF_ALWAYS_CHECK_DESC = "Alerts when a known raid buff isn't active on you.",
    BWV2_CLASS_BUFF_ALWAYS_CHECK = "Always Monitor My Class Buffs",
    BWV2_CLASS_BUFF_ALWAYS_CHECK_DESC = "Alerts when a class buff or weapon imbue is missing.",
    ...
    BWV2_ENCHANT_ID_LABEL = "Enchant ID",
    ...
    BWV2_SECTION_BUFF_DROP = "BUFF DROP ALERT",
    BWV2_REPORT_CARD_POSITION = "Report Card Position",
    BWV2_BUFF_DROP_POSITION = "Buff Drop Alert Position",
    BWV2_GLOW_COLOR = "Glow Color",
    BWV2_GLOW_USE_CLASS_COLOR = "Use Class Color",
    BWV2_GLOW_TYPE = "Glow Type",
    BWV2_GLOW_PIXEL_LINES = "Lines",
    BWV2_GLOW_PIXEL_FREQUENCY = "Speed",
    BWV2_GLOW_PIXEL_LENGTH = "Length",
    BWV2_GLOW_AC_PARTICLES = "Particles",
    BWV2_GLOW_AC_FREQUENCY = "Speed",
    BWV2_GLOW_AC_SCALE = "Scale",
    BWV2_GLOW_BORDER_FREQUENCY = "Speed",
    BWV2_GLOW_PROC_DURATION = "Duration",
    BWV2_GLOW_PROC_START_ANIM = "Start Animation",
    ...
    COMMON_OFFSET_X = "X Offset",
    COMMON_OFFSET_Y = "Y Offset",
    COMMON_ANCHOR_POINT = "Anchor Point",
    COMMON_ANCHOR_TARGET = "Anchor To",
