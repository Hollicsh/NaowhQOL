...
ns:RegisterLocale("enUS", {
    ...
    GENERAL_FONT_DESC = "Choose a game-wide font, then optionally override it for NaowhQOL modules or combat text only.",
    GENERAL_GAME_FONT = "Global Game Font",
    GENERAL_GAME_FONT_DESC = "Used anywhere NaowhQOL can safely update Blizzard UI font objects.",
    GENERAL_QOL_FONT = "NaowhQOL Module Font",
    GENERAL_QOL_FONT_OVERRIDE = "Use a separate NaowhQOL font",
    GENERAL_QOL_FONT_DESC = "When disabled, NaowhQOL modules inherit the global game font.",
    GENERAL_COMBAT_FONT = "Combat Font",
    GENERAL_COMBAT_FONT_OVERRIDE = "Use a separate combat font",
    GENERAL_COMBAT_FONT_DESC = "When disabled, floating combat text inherits the global game font.",
