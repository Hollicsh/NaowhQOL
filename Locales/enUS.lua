...
ns:RegisterLocale("enUS", {
    ...
    BWV2_BUFF_DROP_REMINDER_DESC = "Alert when a buff from your last scan expires. Auto-dismisses on rebuff.",
    BWV2_RAID_BUFF_ALWAYS_CHECK = "Always Monitor My Raid Buffs",
    BWV2_RAID_BUFF_ALWAYS_CHECK_DESC = "Show a missing icon whenever a raid buff you know isn't active on you.",
