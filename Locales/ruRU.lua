...
ns:RegisterLocale("ruRU", {
    ...
    ALERTS_SPELL_ALERTS_NOTE = "Примечание: управляет встроенными наложениями Blizzard для активации заклинаний для каждой специализации каждого класса. Отключение этого модуля восстанавливает стандартные наложения.",
