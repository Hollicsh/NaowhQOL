...
ns:RegisterLocale("ruRU", {
	...
	COMMON_SECTION_POSITION = "ПОЛОЖЕНИЕ",
    ...
    GENERAL_SECTION_FONT = "ШРИФТЫ",
    GENERAL_SECTION_FONTS = "ШРИФТЫ",
    GENERAL_FONT_DESC = "Выберите шрифт, который используют модули NaowhQOL. Системные шрифты интерфейса игры остаются стандартными от Blizzard, если только Вы не выберете опцию ниже.",
    GENERAL_GAME_FONT = "Замена шрифта в игровом интерфейсе",
    GENERAL_GAME_FONT_OPT_IN = "Применить шрифт NaowhQOL к системным шрифтам интерфейса",
    GENERAL_GAME_FONT_DESC = "По умолчанию отключено. Включайте эту опцию, только если хотите, чтобы NaowhQOL обновлял системные тексты интерфейса там, где это можно сделать безопасно.",
    GENERAL_QOL_FONT = "Шрифт модулей NaowhQOL",
    GENERAL_QOL_FONT_OVERRIDE = "Использовать отдельный шрифт для NaowhQOL",
    GENERAL_QOL_FONT_DESC = "Это единственный глобальный шрифт, который NaowhQOL хранит по умолчанию.",
    GENERAL_COMBAT_FONT = "Боевой шрифт",
    GENERAL_COMBAT_FONT_OVERRIDE = "Использовать отдельный боевой шрифт",
    GENERAL_COMBAT_FONT_DESC = "При отключении боевой текст остаётся стандартным от Blizzard, если только не включена замена системного шрифта интерфейса. Для использования плавающего боевого текста после его применения необходимо выйти из системы, чтобы выбрать персонажа.",
    GENERAL_COMBAT_FONT_RELOG = "Для использования плавающего боевого текста требуется выход на экран выбора персонажа для вступления изменений в силу. Это ограничение движка WoW - /reload недостаточно.",
    GENERAL_COMBAT_FONT_LOCKED = "Обнаружен шрифт боевого текста %s. Установите его на стандартный Blizzard там, чтобы использовать эту функцию.",
    GENERAL_APPLY_FONTS = "Применить шрифты",
    GENERAL_FONTS_APPLIED = "Шрифты применены.",
	...
	COMBATALERT_NOTE = "Примечание: отображаются отдельные сообщения о начале и завершении боя с возможностью добавления звука или синтеза речи для каждой переходной фазы.",
	...
	COMBATTIMER_NOTE = "Примечание: таймер запускается при входе в бой, может оставаться на экране после пула и может отправлять финальное время в чат.",
	...
	DRAGON_NOTE = "Примечание: создаёт пользовательский HUD для небесной езды с индикаторами скорости, энергии и рывков. Настройки привязки позволяют закрепить его на другом фрейме.",
	...
	DRAGON_HIDE_CDM_EUI = "Управляется EllesmereUI (скрывать при верховой езде).",
	DRAGON_HIDE_BCM = "Скрыть полосы ресурсов CDM, когда Вы на ездовом животном",
    DRAGON_HIDE_BCM_DESC = "Скрывает полосы ресурсов CDM во время небесного полёта.",
	DRAGON_HIDE_BCM_EUI = "Управляется EllesmereUI (скрывать при верховой езде или полёте на драконе).",
	...
	FOCUS_SHOW_CAST_TARGET = "Показывать заклинания цели",
	...
	FOCUS_HIDE_NONINT = "Скрывать непрерываемые заклинания",
    FOCUS_NONINT_COLOR = "Непрерываемое",
	FOCUS_INTERRUPTED = "Прерывание",
    FOCUS_INTERRUPTED_COLOR = "Цвет прерывания",
    FOCUS_INTERRUPTED_FADE = "Затухание прерывания (сек.)",
    FOCUS_SHOW_INTERRUPTER = "Показывать имя прервавшего",
    ...
    MODULES_SECTION_GLOBAL_COPY = "ГЛОБАЛЬНОЕ КОПИРОВАНИЕ",
    MODULES_ENABLE_GLOBAL_COPY = "Включить глобальное копирование",
    MODULES_GLOBAL_COPY_DESC = "Копировать текст с рамок под курсором или по названию рамки.",
    MODULES_GLOBAL_COPY_NOTE = "Примечание: открывает перемещаемое текстовое окно для видимого текста рамки или ID подсказок. Горячая клавиша игнорируется в бою.",
    MODULES_COPY_TOOLTIP_IDS = "Копировать ID подсказок по горячей клавише",
    MODULES_COPY_MODIFIER = "Модификатор",
	...
	OPT_PRESETS_NOTE = "Примечание: применяет подобранный набор CVar для FPS, графики в рейдах, логирования, сети и визуального шума. Текущие значения сохраняются перед применением, чтобы кнопка 'Отменить' могла их восстановить.",
	...
	STEALTH_POSITION = "Позиция напоминания о скрытности",
    STANCE_POSITION = "Позиция напоминания о стойке",

    CREZ_SUBTITLE = "Таймер боевого воскрешения и оповещения о смертях",
    CREZ_ENABLE_TIMER = "Включить таймер боевого воскрешения",
	CREZ_NOTE = "Примечание: отслеживает количество воскрешений в бою и восстановление их кулдаунов. При смерти игрока предупреждения могут отображать ту же рамку.",
	...
	MOUSE_NOTE = "Примечание: показывает простое кольцо вокруг курсора с возможностью добавления эффекта трассировки и индикатора глобальной перезарядки (ГКД). Правила видимости позволяют скрывать его вне боя, при нажатии кнопок мыши или когда объект не в фокусе.",
	...
	MOUSE_SHAPE_CIRCLE2 = "Мягкий круг",
    MOUSE_SHAPE_CIRCLE3 = "Жесткий круг",
    MOUSE_SHAPE_RING1 = "Кольцо 1",
    MOUSE_SHAPE_RING2 = "Кольцо 2",
    MOUSE_SHAPE_RING3 = "Кольцо 3",
    MOUSE_SHAPE_RING4 = "Кольцо 4",
    MOUSE_SHAPE_RING_SOFT1 = "Мягкое кольцо 1",
    MOUSE_SHAPE_RING_SOFT2 = "Мягкое кольцо 2",
    MOUSE_SHAPE_RING_SOFT3 = "Мягкое кольцо 3",
    MOUSE_SHAPE_RING_SOFT4 = "Мягкое кольцо 4",
    MOUSE_SHAPE_GLOW = "Свечение",
    MOUSE_SHAPE_GLOW2 = "Свечение 2",
    MOUSE_SHAPE_GLOW_REVERSED = "Обратное свечение",
    MOUSE_SHAPE_CROSS1 = "Крест",
    MOUSE_SHAPE_CROSS2 = "Крест 2",
    MOUSE_SHAPE_CROSS3 = "Крест 3",
    MOUSE_SHAPE_STAR = "Звезда",
    MOUSE_SHAPE_SWIRL = "Вихрь",
    MOUSE_SHAPE_SPHERE = "Край круга",
    ...
    MOUSE_SECTION_DISPEL_CURSOR = "ВОССТАНОВЛЕНИЕ РАССЕИВАНИЯ",
    MOUSE_DISPEL_CURSOR_ENABLE = "Показывать восстановление развеивания у курсора",
    MOUSE_DISPEL_CURSOR_COLOR = "Цвет текста",
    MOUSE_DISPEL_CURSOR_OFFSET_X = "Смещение текста по оси X",
    MOUSE_DISPEL_CURSOR_OFFSET_Y = "Смещение текста по оси Y",
    MOUSE_DISPEL_CURSOR_NOTE = "Примечание: определяет Ваше текущее заклинание развеивания с союзников (включая развеивания питомцев, если они поддерживаются) и отображает у курсора число с его перезарядкой.",
	...
	MOUSE_TRAIL_SHAPE = "Форма следа",
    MOUSE_TRAIL_SHAPE_GLOW = "Свечение",
    MOUSE_TRAIL_SHAPE_CIRCLE = "Круг",
    MOUSE_TRAIL_SHAPE_RING = "Кольцо",
    MOUSE_TRAIL_SHAPE_STAR = "Звезда",
    MOUSE_TRAIL_SHAPE_SPARKLE = "Свечение",
    MOUSE_TRAIL_SIZE = "Размер следа",
    MOUSE_TRAIL_LENGTH = "Длина следа",
    MOUSE_TRAIL_BRIGHTNESS = "Яркость следа",
    MOUSE_TRAIL_SPARKLE = "Цвета свечения",
	...
	MOUSE_SECTION_DOT = "ТОЧКА В ЦЕНТРЕ",
    MOUSE_DOT_ENABLE = "Включить центральную точку",
    MOUSE_DOT_COLOR = "Цвет точки",
    MOUSE_DOT_SIZE = "Размер точки",

    MOUSE_SECTION_FADE = "ЗАТУХАНИЕ НА БЕЗДЕЙСТВИИ",
    MOUSE_FADE_ENABLE = "Затухание при бездействии мыши",
    MOUSE_FADE_DELAY = "Задержка в режиме ожидания (мс)",
    MOUSE_FADE_OPACITY = "Прозрачность в режиме ожидания",

    CROSSHAIR_TITLE = "ПРИЦЕЛ",
    CROSSHAIR_SUBTITLE = "Наложение прицела в центре экрана",
    CROSSHAIR_ENABLE = "Включить прицел",
	CROSSHAIR_NOTE = "Примечание: отображает настраиваемый центральный прицел для боя с выбором формы, сменой цвета по дистанции и возможностью звуковых сигналов.",
	...
	PETTRACKER_SHOW_PASSIVE = "Показывать уведомления 'Питомец пассивен'",
	...
	MOVEMENT_ALERT_NOTE = "Примечание: отслеживает средства передвижения для Вашего текущего класса и любых добавленных Вами пользовательских ID заклинаний. Фильтры по классам позволяют отключить оповещения для специализаций, которым это не нужно.",
	MOVEMENT_POSITION_MAIN = "Положение предупреждения о движении",
    MOVEMENT_POSITION_SPIRAL = "Положение 'Спираль времени'",
    MOVEMENT_POSITION_GATEWAY = "Положение 'Осколок управления вратами'",
	...
	TIME_SPIRAL_NOTE = "Примечание: следит за событиями проков 'Спираль времени' от стандартного интерфейса Blizzard и учитывает замены заклинаний в зависимости от специализации, прежде чем показать оповещение о свободе перемещения.",
	...
	GATEWAY_SHARD_NOTE = "Примечание: следит за предметом 'Осколок управления вратами' и может подавать звуковой сигнал или голосовое оповещение (TTS) в бою, когда предмет становится доступен для использования.",
    ...
    ALERTS_SUBTITLE = "Наложения заклинаний, развеивание и утилиты готовности зелий",
    ALERTS_SPELL_ALERTS = "ОПОВЕЩЕНИЯ О ЗАКЛИНАНИЯХ",
    ALERTS_ENABLE_SPELL_ALERTS = "Включить оповещения о заклинаниях",
    ALERTS_CURRENT_SPEC = "Текущая специализация",
    ALERTS_ENABLE_CURRENT_SPEC = "Включить наложения для %s",
    ALERTS_SPELL_ALERT_OPACITY = "Прозрачность наложения",
    ALERTS_SPELL_ALERTS_NOTE = "Примечание: при включении предупреждения показываются только для выбранных специализаций (ни одна не выбрана - предупреждения отключены). Полное отключение модуля вернёт наложения для всех специализаций.",
	ALERTS_SPELL_ALERTS_PROCGLOWS = "Примечание: ProcGlows загружен. Наложения оповещений о заклинаниях остаются включёнными, чтобы свечения на панелях действий от ProcGlows могли работать. Скрытие для каждой специализации приостанавливается, пока присутствует ProcGlows.",
    ALERTS_DISPEL_GLOW = "СВЕЧЕНИЕ РАССЕИВАНИЯ",
    ALERTS_ENABLE_DISPEL_GLOW = "Включить свечение развеивания",
    ALERTS_USE_DISPEL_COLOR = "Использовать цвет типа развеивания",
    ALERTS_ENABLE_GLOW_ANIM = "Включить анимацию свечения",
    ALERTS_DISPEL_GLOW_NOTE = "Примечание: подсвечивает стандартные компактные рамки групп Blizzard и распространённые рамки групп ElvUI, когда аддон может развеять вредоносную ауру на союзнике. Личные ауры по-прежнему полагаются на стандартные индикаторы Blizzard.",
    ALERTS_POTION_READY = "ЗЕЛЬЕ ГОТОВО",
    ALERTS_ENABLE_POTION = "Включить оповещение о готовности зелья",
    ALERTS_POTION_TEXT = "Отображаемый текст:",
    ALERTS_INSTANCE_ONLY = "Только подземелья и рейды",
    ALERTS_DISABLE_HEALER = "Отключить для лекарей",
    ALERTS_POTION_READY_NOTE = "Примечание: показывает перемещаемое оповещение, когда отслеживаемое боевое зелье находится в Ваших сумках и не на перезарядке. Звук, свечение, фильтры для лекарей и типов подземелий являются опциональными.",
	...
	BWV2_BUFF_DROP_INSTANCE_ONLY = "Только подземельях/рейдах",
    BWV2_BUFF_DROP_DISABLE_RESTED = "Прятать в местах отдыха.",
    BWV2_BUFF_DROP_TEXT = "Шрифт текста длительности",
    BWV2_BUFF_DROP_NO_TINT = "Без красного оттенка",
    BWV2_BUFF_DROP_NO_TINT_DESC = "Показывать отсутствующие баффы только обесцвеченными, без красного оттенка.",
    BWV2_RAID_TEXT_ONLY = "Текстовый режим рейдовых баффов",
    BWV2_RAID_TEXT_ONLY_DESC = "Показывать отсутствующие рейдовые баффы в виде текстового списка в отдельной привязке вместо иконок.",
    BWV2_RAID_TEXT_ANCHOR = "Текст рейдовых баффов",
    BWV2_RAID_TEXT_COLOR = "Цвет текста",
    BWV2_RAID_TEXT_FONT_SIZE = "Размер текста",
    BWV2_BUFF_DROP_MISSING = "Отсутствует",
    ...
    BWV2_SECTION_BUFF_DROP = "УВЕДОМЛЕНИЕ О СПАВШЕМ БАФФЕ",
	BWV2_REPORT_CARD_POSITION = "Положение отчёта об успеваемости",
    BWV2_BUFF_DROP_POSITION = "Позиция оповещения о спадении баффа",
    BWV2_GLOW_COLOR = "Цвет свечения",
	BWV2_GLOW_USE_CLASS_COLOR = "Использовать цвет класса",
    BWV2_GLOW_TYPE = "Тип свечения",
    BWV2_GLOW_PIXEL_LINES = "Линии",
    BWV2_GLOW_PIXEL_FREQUENCY = "Частота",
    BWV2_GLOW_PIXEL_LENGTH = "Длина",
    BWV2_GLOW_AC_PARTICLES = "Частицы",
    BWV2_GLOW_AC_FREQUENCY = "Скорость",
    BWV2_GLOW_AC_SCALE = "Масштаб",
    BWV2_GLOW_BORDER_FREQUENCY = "Частота границы",
    BWV2_GLOW_PROC_DURATION = "Продолжительность",
    BWV2_GLOW_PROC_START_ANIM = "Начало анимации",
    ...
    BWV2_CONSUMABLE_ALWAYS_CHECK = "Всегда отслеживать расходные материалы",
    BWV2_CONSUMABLE_ALWAYS_CHECK_DESC = "Оповещает, когда отслеживаемый бафф от расходуемого предмета не активен.",
    BWV2_INVENTORY_ALWAYS_CHECK = "Всегда отслеживать свой инвентарь",
    BWV2_INVENTORY_ALWAYS_CHECK_DESC = "Оповещает при отсутствии 0 единиц отслеживаемого предмета (например: зелий, камней здоровья).",
	...
	COMMON_OFFSET_X = "Смещение по оси X",
    COMMON_OFFSET_Y = "Смещение по оси Y",
    COMMON_ANCHOR_POINT = "Точка крепления",
    COMMON_ANCHOR_TARGET = "Привязать к",
