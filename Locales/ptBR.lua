...
ns:RegisterLocale("ptBR", {
    ...
    DRAGON_HIDE_BCM = "Ocultar barras de poder do BCM ao montar",
    DRAGON_HIDE_BCM_DESC = "Oculta as barras de poder e poder secundário do BetterCooldownManager durante voo celestial.",
