...
ns:RegisterLocale("ptBR", {
    ...
    COMMON_RIGHT_CLICK_SETTINGS = "Clique direito para configurações",
    ...
    DRAGON_HIDE_BCM = "Ocultar barras de recursos CDM ao montar",
    DRAGON_HIDE_BCM_DESC = "Oculta as barras de recursos CDM durante voo celestial.",
    ...
    STEALTH_STANCE_INSTANCE_ONLY = "Apenas em Masmorras / Raides",
    STEALTH_GROUP_ONLY = "Apenas em grupo (Ocultar solo)",
    ...
    MOUSE_HIDE_UNFOCUSED = "Ocultar quando AFK",
    ...
    PETTRACKER_FELGUARD_LABEL = "Vil Guard (substituição):",
    ...
    BWV2_ENCHANT_ID_LABEL = "ID de Encantamento",
    ...
    BWV2_SECTION_PRESENCE = "Buffs de Presença",
    ...
    BWV2_SECTION_BUFF_DROP = "Alerta de Buff Perdido",
    BWV2_GLOW_COLOR = "Cor do Brilho",
    ...
    BWV2_RAID_BUFF_ALWAYS_CHECK = "Sempre monitorar meus buffs de reide",
    ...
    IMPORTEXPORT_IMPORT_OK_PROFILE = "Importado para novo perfil: %s",
    ...
    IMPORTEXPORT_POPUP_IMPORT   = "Digite um nome para o novo perfil de importação:",
    IMPORTEXPORT_POPUP_DELETE   = "Excluir perfil '%s'?",
    IMPORTEXPORT_POPUP_RESET    = "Redefinir o perfil padrão para as configurações de fábrica?\n\nIsso desativará TODOS os recursos e redefinirá todas as cores/posições. É necessário recarregar.",
    IMPORTEXPORT_RESET_BTN      = "Redefinir para Padrão",
    IMPORTEXPORT_RESET_OK       = "Perfil padrão redefinido — recarregue para aplicar",
    IMPORTEXPORT_RESET_ERR_NAMED = "Redefinir só funciona no perfil padrão",
    ...
    GENERAL_SECTION_OPTIONS = "OPÇÕES",
    GENERAL_DISABLE_LOGIN_MSG = "Desativar mensagem de login",
