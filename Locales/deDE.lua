...
ns:RegisterLocale("deDE", {
    ...
    DRAGON_HIDE_BCM = "BCM-Machtleisten beim Reiten ausblenden",
    DRAGON_HIDE_BCM_DESC = "Blendet die Machtleisten und sekundären Machtleisten des BetterCooldownManagers beim Himmelsreiten aus.",
