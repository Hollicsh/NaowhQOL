...
ns:RegisterLocale("deDE", {
    ...
    STEALTH_STANCE_INSTANCE_ONLY = "Nur in Dungeons / Schlachtzügen",
    STEALTH_GROUP_ONLY = "Nur mit Gruppe (In Solo ausblenden)",
    ...
    MOUSE_HIDE_UNFOCUSED = "Bei AFK ausblenden",
    ...
    BWV2_ENCHANT_ID_LABEL = "Verzauberungs-ID",
    ...
    BWV2_SECTION_PRESENCE = "ANWESENHEITSBUFFS",
    ...
    BWV2_SECTION_BUFF_DROP = "BUFF-ABFALL-WARNUNG",
    BWV2_GLOW_COLOR = "Leuchtfarbe",
    ...
    BWV2_RAID_BUFF_ALWAYS_CHECK = "Meine Schlachtzugsbuffs immer überwachen",
    ...
    IMPORTEXPORT_IMPORT_OK_PROFILE = "In neues Profil importiert: %s",
    ...
    IMPORTEXPORT_POPUP_IMPORT   = "Einen Namen für das neue Profil zum Importieren eingeben:",
    IMPORTEXPORT_POPUP_DELETE   = "Profil '%s' löschen?",
    IMPORTEXPORT_POPUP_RESET    = "Standardprofil auf Werkseinstellungen zurücksetzen?\n\nDies deaktiviert ALLE Funktionen und setzt alle Farben/Positionen zurück. Ein Neuladen ist erforderlich.",
    IMPORTEXPORT_RESET_BTN      = "Auf Standard zurücksetzen",
    IMPORTEXPORT_RESET_OK       = "Standardprofil zurückgesetzt — neu laden zum Anwenden",
    IMPORTEXPORT_RESET_ERR_NAMED = "Zurücksetzen funktioniert nur beim Standardprofil",
    ...
    GENERAL_SECTION_OPTIONS = "OPTIONEN",
    GENERAL_DISABLE_LOGIN_MSG = "Anmeldenachricht deaktivieren",
