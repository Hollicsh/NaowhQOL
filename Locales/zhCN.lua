...
ns:RegisterLocale("zhCN", {
    ...
    DRAGON_HIDE_BCM = "骑乘时隐藏 CDM 资源条",
    DRAGON_HIDE_BCM_DESC = "在天空骑行时隐藏 CDM 的资源条。",
    ...
    BWV2_RAID_BUFF_ALWAYS_CHECK = "始终监控我的团队增益",
    ...
    IMPORTEXPORT_IMPORT_OK_PROFILE = "已导入至新配置文件：%s",
    IMPORTEXPORT_IMPORT_ERR     = "导入失败。",
    IMPORTEXPORT_POPUP_RENAME   = "将配置文件 '%s' 重命名为：",
    IMPORTEXPORT_POPUP_NEW      = "使用默认设置创建新配置文件：",
    IMPORTEXPORT_POPUP_IMPORT   = "输入要导入的新配置文件名称：",
    IMPORTEXPORT_POPUP_DELETE   = "删除配置文件 '%s'？",
    IMPORTEXPORT_POPUP_RESET    = "将默认配置文件重置为出厂设置？\n\n这将关闭所有功能并重置所有颜色/位置。需要重新加载。",
    IMPORTEXPORT_RESET_BTN      = "重置为默认值",
    IMPORTEXPORT_RESET_OK       = "默认配置文件已重置 — 请重新加载以应用",
    IMPORTEXPORT_RESET_ERR_NAMED = "重置仅适用于默认配置文件",
