...
ns:RegisterLocale("zhCN", {
    ...
    MOVEMENT_ALERT_CLASS_FILTER = "追踪以下职业:",
    MOVEMENT_ALERT_TRACKED_SPELLS = "追踪法术",
    MOVEMENT_ALERT_TRACKED_SPELLS_DESC = "选择要追踪的法术并设置自定义名称:",
    MOVEMENT_ALERT_CUSTOM_TEXT = "自定义名称:",
    MOVEMENT_ALERT_ADD_SPELL = "添加法术ID:",
    MOVEMENT_ALERT_NO_SPELLS = "该职业未配置法术",
    TIME_SPIRAL_ENABLE = "启用时间螺旋追踪",
    TIME_SPIRAL_SETTINGS = "时间螺旋设置",
    TIME_SPIRAL_TEXT = "显示文本:",
    TIME_SPIRAL_TEXT_DEFAULT = "自由移动",
    TIME_SPIRAL_TEXT_FORMAT = "文本格式:",
    TIME_SPIRAL_TEXT_FORMAT_DEFAULT = "自由移动\\n%ts",
    TIME_SPIRAL_TEXT_FORMAT_HELP = "%t = 剩余时间, \\n = 换行",
