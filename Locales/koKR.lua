...
ns:RegisterLocale("koKR", {
    ...
    DRAGON_HIDE_BCM = "탑승 중 CDM 자원 바 숨기기",
    DRAGON_HIDE_BCM_DESC = "하늘 비행 중 CDM 자원 바를 숨깁니다.",
    ...
    STEALTH_STANCE_INSTANCE_ONLY = "던전 / 레이드 전용",
    STEALTH_GROUP_ONLY = "그룹 전용 (솔로 시 숨김)",
    ...
    MOUSE_HIDE_UNFOCUSED = "자리 비움 시 숨기기",
    ...
    BWV2_RAID_BUFF_ALWAYS_CHECK = "내 공격대 버프 항상 모니터링",
    ...
    IMPORTEXPORT_IMPORT_OK_PROFILE = "새 프로필로 가져오기 완료: %s",
    IMPORTEXPORT_IMPORT_ERR     = "가져오기 실패.",
    IMPORTEXPORT_POPUP_RENAME   = "프로필 '%s'의 이름을 변경:",
    IMPORTEXPORT_POPUP_NEW      = "기본 설정으로 새 프로필 만들기:",
    IMPORTEXPORT_POPUP_IMPORT   = "가져올 새 프로필의 이름을 입력하세요:",
    IMPORTEXPORT_POPUP_DELETE   = "프로필 '%s'을(를) 삭제하시겠습니까?",
    IMPORTEXPORT_POPUP_RESET    = "기본 프로필을 초기 설정으로 재설정하시겠습니까?\n\n모든 기능이 비활성화되고 모든 색상/위치가 재설정됩니다. 리로드가 필요합니다.",
    IMPORTEXPORT_RESET_BTN      = "기본값으로 재설정",
    IMPORTEXPORT_RESET_OK       = "기본 프로필 재설정 완료 — 적용하려면 리로드하세요",
    IMPORTEXPORT_RESET_ERR_NAMED = "재설정은 기본 프로필에서만 작동합니다",
    ...
    GENERAL_SECTION_OPTIONS = "옵션",
    GENERAL_DISABLE_LOGIN_MSG = "로그인 메시지 비활성화",
