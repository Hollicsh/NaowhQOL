...
ns:RegisterLocale("frFR", {
    ...
    DRAGON_HIDE_BCM = "Masquer les barres BCM en monture",
    DRAGON_HIDE_BCM_DESC = "Masque les barres de puissance et de puissance secondaire du BetterCooldownManager pendant le vol céleste.",
