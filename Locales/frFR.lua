...
ns:RegisterLocale("frFR", {
    ...
    DRAGON_HIDE_BCM = "Masquer les barres de ressources CDM en monture",
    DRAGON_HIDE_BCM_DESC = "Masque les barres de ressources CDM pendant le vol céleste.",
    ...
    STEALTH_STANCE_INSTANCE_ONLY = "Donjons / Raids uniquement",
    STEALTH_GROUP_ONLY = "Groupe uniquement (Masquer en solo)",
    ...
    MOUSE_HIDE_UNFOCUSED = "Masquer en mode AFK",
    ...
    BWV2_ENCHANT_ID_LABEL = "ID d'enchantement",
    ...
    BWV2_SECTION_PRESENCE = "BUFFS DE PRÉSENCE",
    ...
    BWV2_SECTION_BUFF_DROP = "ALERTE BUFF PERDU",
    BWV2_GLOW_COLOR = "Couleur du halo",
    ...
    BWV2_RAID_BUFF_ALWAYS_CHECK = "Toujours surveiller mes buffs de raid",
    BWV2_RAID_BUFF_ALWAYS_CHECK_DESC = "Affiche une icône d'absence lorsqu'un buff de raid que vous connaissez n'est pas actif sur vous.",
    BWV2_CLASS_BUFF_ALWAYS_CHECK = "Toujours surveiller mes buffs de classe",
    BWV2_CLASS_BUFF_ALWAYS_CHECK_DESC = "Surveille en continu vos buffs de classe (ex. poisons, enchantements d'arme) et alerte en cas d'absence.",
    ...
    IMPORTEXPORT_IMPORT_OK_PROFILE = "Importé dans le nouveau profil : %s",
    ...
    IMPORTEXPORT_POPUP_IMPORT   = "Entrez un nom pour le nouveau profil d'importation :",
    IMPORTEXPORT_POPUP_DELETE   = "Supprimer le profil '%s' ?",
    IMPORTEXPORT_POPUP_RESET    = "Réinitialiser le profil par défaut aux paramètres d'usine ?\n\nCela désactivera TOUTES les fonctionnalités et réinitialisera toutes les couleurs/positions. Un rechargement est nécessaire.",
    IMPORTEXPORT_RESET_BTN      = "Réinitialiser par défaut",
    IMPORTEXPORT_RESET_OK       = "Profil par défaut réinitialisé — rechargez pour appliquer",
    IMPORTEXPORT_RESET_ERR_NAMED = "La réinitialisation ne fonctionne que sur le profil par défaut",
    ...
    GENERAL_DISABLE_LOGIN_MSG = "Désactiver le message de connexion",
