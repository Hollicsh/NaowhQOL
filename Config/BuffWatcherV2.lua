...
function ns:InitBuffWatcherV2()
    ...
    W:CachedPanel(cache, "bwv2Frame", p, function(f)
        ...
        -- Chat report toggle (next to master enable)
        ...
        -- Preview function for Report Card settings (only when enabled and unlocked)
        ...
        -- Row 3: Auto-close delay / Scan on Login
        W:CreateSlider(rcContent, {
