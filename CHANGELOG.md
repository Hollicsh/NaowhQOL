...
### Bug Fixes
  ...
  - Movement Cooldown Alert: Burning Rush now tracks your casts (toggle on/off) instead of reading the buff aura, so the alert stays visible through combat and Mythic+.
