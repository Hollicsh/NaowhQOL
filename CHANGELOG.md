...
### Bug Fixes
  ...
  - Movement Cooldown Alert: Burning Rush now uses aura-instance tracking (cast arms tracking, `UNIT_AURA` added/removed instance IDs) so it works in combat without relying on readable aura spell IDs.